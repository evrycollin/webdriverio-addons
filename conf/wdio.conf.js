...
//    ],
    ...
    //baseUrl: 'https://listedenaissance.orchestra.fr',
    ...
    plugins: {
      'webdriverio-addons' : {
        visualReferenceDir: './refScreenshots',
        screenshot : {
          folder: './screenshots',
          maskColor: 'red',
          diff: {
            highlightColor: 'purple',
            highlightStyle: 'Tint', // can be :  Assign | Tint | Threshold | XOR
            metric: 'MSE',
            tolerance: 0.00001
          }
        }
      ...
      /* webdrivercss: {
            ...
            api: 'http://vps226714.ovh.net:9000/api/repositories/'
...
//        browserevent: {}
    ...
    reporters: ['dot','spec','junit', 'allure-addons'],
    reporterOptions: {
        'outputDir': 'outputDir',
        'allure-addons': {
        ...
        'junit': {
          outputFileFormat: function(context) { 
            console.log('context junit reporter',context);
            return 'junit-'+require('uuid').v4()+'.xml'; 
          }
        }
    },    
    //
