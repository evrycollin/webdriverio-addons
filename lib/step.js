...
function Step(title) {
    ...
    Step.prototype.ko = function( message, detail ) {
      ...
      //tools.takeFullScreenshot('Error screenshot test ko : '+(message!=null ? message : ''), this);
      this.done('failed', message, detail);
    };    
    Step.prototype.error = function( message, detail ) {
      tools.takeFullScreenshot('Error screenshot test error : '+(message!=null ? message : ''), this);
    ...
    Step.prototype.assertVisual = function( refScreenshot, test, message ) {
      try {
        ...
        tools.takeFullScreenshot('Error assertVisual : '+refScreenshot+' '+(message!=null ? message : ''), this);
        this.ko(message, err);
        throw err;
      }
      return this;
    ...
    Step.prototype.takeFullScreenshot = function(title) {
      tools.takeFullScreenshot(title, this);
      return this;
    };    
